...
hparams = tf.contrib.training.HParams(
    ...
    # CBHG mel->pit postnet
    cbhg_kernels=3,
    # All kernel sizes from 1 to cbhg_kernels will be used in the convolution bank of CBHG to act as "K-grams"
    cbhg_conv_channels=32,  # Channels of the convolution bank
    cbhg_pool_size=2,  # pooling size of the CBHG
    cbhg_projection=64,  # projection channels of the CBHG (1st projection, 2nd is automatically set to num_mels)
    cbhg_projection_kernel_size=3,  # kernel_size of the CBHG projections
    cbhg_highwaynet_layers=2,  # Number of HighwayNet layers
    cbhg_highway_units=32,  # Number of units used in HighwayNet fully connected layers
    cbhg_rnn_units=32,
